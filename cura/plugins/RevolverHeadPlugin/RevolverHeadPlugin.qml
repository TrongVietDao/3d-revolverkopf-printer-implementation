...
UM.Dialog
{
    ...
    title: catalog.i18nc("@title:window", "RevolverHead Stuff")
    ...
    Item
    {
        ...
        Item
        {
            ...
            Label
            {
                ...
                text: catalog.i18nc("@label", "RevolverHead Scripts")
            ...
            {
                id: addButton
                text: catalog.i18nc("@action", "Number of Extruders")
                anchors.left: parent.left
                anchors.leftMargin: base.textMargin
            ...
            {
                id: addButton2
                text: catalog.i18nc("@action", "Optimization")
                anchors.left: parent.left
                anchors.leftMargin: base.textMargin
            ...
            {
                id: addButton3
                text: catalog.i18nc("@action", "Something else")
                anchors.left: parent.left
                anchors.leftMargin: base.textMargin
                anchors.top: addButton2.bottom
                anchors.topMargin: base.textMargin
                menu: scriptsMenu
                style: ButtonStyle
                {
            ...
            CheckBox
            {
                checked: false
                id: checkBox
                text: catalog.i18nc("@action", "Check this")
                anchors.left: parent.left
                anchors.leftMargin: base.textMargin
                anchors.top: addButton3.bottom
                anchors.topMargin: base.textMargin
            }
            CheckBox
            {
                checked: false
                id: checkBox2
                text: catalog.i18nc("@action", "Check that")
                anchors.left: parent.left
                anchors.leftMargin: base.textMargin
        ...
        Rectangle
        {
            ...
            Label
            {
                ...
                text: manager.selectedScriptIndex == -1 ? catalog.i18nc("@label", "Description") : base.activeScriptName
                anchors
                {
                    top: parent.top
                    topMargin: base.textMargin
