...
public:
    ...
    /*!
     * \brief Set an int value to represent the current servo position.
     *
     * Set an int value to represent the current servo position.
     * Important, this does NOT set the servo position but rather save it in a variable.
     * \param pos
     */
    void setServoPosition(int pos);

    /*!
     * Get an int value representing the current servo position.
     * \return An int representing the current servo position.
     */
...
private:
    ...
    /*!
     * Variable to save current servo position.
     */
    int servoPosition;
};
